...
- অ্যাপ: `https://israfil-hossen.github.io/Adult-hifz/hifz-1.0.4/`
...
আপডেটের নিয়ম: ফাইল বদলে push করুন, আর `hifz-1.0.4/sw.js`-এর `CACHE` মানটা
...
| কী | কোথায় |
|---|---|
| আইকন ৫১২×৫১২ | `hifz-1.0.4/icon-512.png` |
