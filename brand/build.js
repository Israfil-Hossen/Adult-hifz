...
(async () => {
  ...
  await save(await sharp(await markOn(1024, NAVY, GOLD, 1024 * 0.58, 512)).resize(512).png().toBuffer(), 'hifz-1.0.8/icon-maskable-512.png');
  ...
  await save(await lockup(1024, PARCH, NAVY, NAVY, MUTED_L), 'hifz-1.0.8/splash-lockup.png');
  await save(await lockup(1024, NAVY, GOLD, PARCH, MUTED_D), 'hifz-1.0.8/splash-lockup-dark.png');
